...
func processData(input varying int) varying int {
...
func advancedProcess(data varying int, multiplier varying int) varying int {
...
func nestedSPMDProcessing(base varying int, factor varying int) varying int {
...
func demonstrateNestedCalls() {
	...
	// From SPMD context
	go for i := range 4 {
		localBase := varying(i * 8)
		localFactor := varying(3)
