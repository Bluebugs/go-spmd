...
func createConstantVarying() varying int {
...
func processAndReduce() varying int {
...
func arrayToVarying() varying int {
...
func illegalFunction() varying int {
...
func spmdFunction(input varying int) varying int {
...
func uniformToVarying(base int) varying int {
...
func complexProcessing() varying float64 {
